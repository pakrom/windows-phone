...
namespace MemoryDiagnostics
{
    ...
    public static class MemoryDiagnosticsHelper
    {
        ...
        public static void Start(TimeSpan timespan, bool forceGc)
        {
            ...
            //max_memory = DeviceStatus.ApplicationMemoryUsageLimit;
        ...
        public static void Checkpoint(string text)
        {
            ...
            recentCheckpoints.Enqueue(new MemoryCheckpoint(text, DeviceStatus.ApplicationCurrentMemoryUsage));
        }
        ...
        {
            long mem = DeviceStatus.ApplicationCurrentMemoryUsage;
